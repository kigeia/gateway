...
logger.info(`complus 1`)
var uni = require('@complus/sdk-ava')
logger.info(`complus 2`)
var chainID = 43114
const uniswap = new Uniswap(chainID, uni, process.env.COMPLUSAVA_ROUTER)
logger.info(`complus 3`)
logger.info(uniswap.chainID)
logger.info(uniswap.providerUrl)
logger.info(uniswap.router)
logger.info(uniswap.uni.INIT_CODE_HASH)
